      ...
      <div className="container mx-auto px-6 max-w-6xl">
        <section className="text-center max-w-3xl mx-auto">
          ...
          <p className="mt-6 text-gray-600 text-lg">
            Hudini School Of Science & Technology is a reputable learning
            institution located in Victoria Falls, Zimbabwe, dedicated to
            providing quality secondary education grounded in discipline,
        ...
        <section className="mt-24 grid md:grid-cols-2 gap-12">
          <div className="border rounded-xl p-8">
            ...
            <p className="text-gray-700 leading-relaxed">
              To foster students love for learning and encourage endorsement of
              self motivated intelligence with a strong foundation to build
              character on. Building a more inclusive curriculum that promotes
              critical thinking, creativity, and holistic development in a safe
              and disciplined environment., adressing a range of learning styles
              and offering a wide array of diversity, efforts and promoting a
              culture od genuine enthusiasm with a distinct flair
            </p>
          </div>
